 ...
 return Ext.create('Ext.form.Panel',{
	...
	xtype: 'combobox',
      ...
      name: 'contractor',
value: contractor_store.getAt('0').get('middle_name'),
	...
	xtype: 'combobox',
      fieldLabel: "Компания",
      name: 'company',
value: company_store.getAt('0').get('name'),
    store: company_store,
    queryMode: 'local',
    displayField: 'name',
    valueField: 'id',
...
value: employee_store.getAt('0').get('login'),
	...
	xtype: 'combobox',
      ...
      name: 'eventType',
value: event_type_store.getAt('0').get('name'),
	...
	xtype: 'combobox',
      ...
      name: 'eventStatus',
value: event_status_store.getAt('0').get('name'),
